...
!
      ...
      integer nssppt,nsshum,nsepbl,nsocnsppt,nsocnskeb, nsskeb,lon_s,lat_s,ntrunc
...
! pjp stochastic phyics
      ...
      real(kind=kind_dbl_prec) :: skeb_sigtop1,skeb_sigtop2,          &
                         ...
                         skeb_vdof
      real(kind=kind_dbl_prec) skeb_diss_smooth,epblint,ocnspptint,ocnskebint,spptint,shumint,skebint,skebnorm
